...
compile actually-working-compile-without-v3-garbage: draft-iab-path-signals-collaboration.md
	cat draft-iab-path-signals-collaboration.md  | kramdown-rfc2629 | lib/add-note.py > draft-iab-path-signals-collaboration-pre.xml
	...
	xml2rfc -q --cache=$(HOME)/.cache/xml2rfc draft-iab-path-signals-collaboration.xml -o draft-iab-path-signals-collaboration.txt --text
	xml2rfc -q --cache=$(HOME)/.cache/xml2rfc draft-iab-path-signals-collaboration.xml -o draft-iab-path-signals-collaboration.html --html
